...
namespace LidyaPos\SeoHelper\Entities\Twitter;

use LidyaPos\SeoHelper\Contracts\Entities\MetaCollectionContract;
use LidyaPos\SeoHelper\Contracts\Entities\TwitterCardContract;
use LidyaPos\SeoHelper\Exceptions\InvalidTwitterCardException;
